class acd3 {
    ...
    scaleResolution(player) {
        // implemented this here because we have direct access to player in
		// playerStore, where as in
        // the createYoutubePlayerReady method, we had to access the player by
		// the player
    ...
    expandBubbleChrome(data, i, videoID) {
        ...
        // select individual div and reassign z-index of individual div to 1.
		// Also increase size.
        ...
        // select individual iframe that was clicked and increase it's size and
		// center
        d3.select(`#${videoID}`)
        ...
        // select individual foreignObject which contains div and ifram and
		// position it to desired location
    ...
    getEmbeddedURL(inputString, type) {
        /*
		 * type can be youtube vimeo video
		 * 
		 * inputString can be embedded video link -->
		 * https://www.youtube.com/embed/39udgGPyYMg non-embedded video link -->
		 * https://www.youtube.com/watch?v=39udgGPyYMg video ID --> 39udgGPyYMg
		 * inputString can be from sources youtube -->
		 * https://www.youtube.com/embed/39udgGPyYMg vimeo -->
		 * https://player.vimeo.com/video/12788201 direct link to video -->
		 * http://upload.wikimedia.org/wikipedia/commons/7/79/Big_Buck_Bunny_small.ogv
		 * 
		 * function returns for youtube and vimeo ==> embedded video link for
		 * direct links to videos ==> returns same link
		 */
